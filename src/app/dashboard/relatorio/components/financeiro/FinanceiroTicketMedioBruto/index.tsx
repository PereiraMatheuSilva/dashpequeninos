...
export function FinanceiroTicketMedioBruto(){
  ...
  return(
      <div className="w-full min-h-screen space-y-6">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between   gap-4">
            <h1 className="text-2xl font-bold">Ticket Medio (Bruto)</h1>
            <DateRangePicker 
              onChange={(start, end) => {
                setStartDate(start)
                setEndDate(end)
          ...
          <h2 className="text-lg font-semibold mb-2">Ticket Medio (Bruto)</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <TotalsCard title="Ticket Medio Bruto" value={
              financeiro?.ticketMedioBruto ? `R$ ${financeiro?.ticketMedioBruto.toFixed(1)}` : '0,00'
            } icon="dollar-sign" />
