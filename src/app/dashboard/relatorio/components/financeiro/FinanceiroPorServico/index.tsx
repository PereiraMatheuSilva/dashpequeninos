...
export function FinanceiroPorServico(){
  ...
  return(
      <div className="w-full min-h-screen space-y-6">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between   gap-4">
            <h1 className="text-2xl font-bold">Receita por Serviço (B)</h1>
            <DateRangePicker 
              onChange={(start, end) => {
                setStartDate(start)
                setEndDate(end)
          ...
          {financeiro?.receitaBrutaPorServico && (
            <Component data={financeiro.receitaBrutaPorServico} />
          )}
