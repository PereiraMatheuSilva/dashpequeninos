...
export function OutrosMediaAtendimentos(){
  ...
  return(
    <div className="w-full min-h-screen space-y-6">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between   gap-4">
        <h1 className="text-2xl font-bold">Média de atendimentos e outros indicadores</h1>
        <DateRangePicker
          onChange={(start, end) => {
            setStartDate(start)
            setEndDate(end)
      ...
      <h2 className="text-lg font-semibold mb-2">Total / n° de profissionais ativos</h2>
      ...
      <h2 className="text-lg font-semibold mb-2">Valor Repassado (atendimento x 0,80 por profissional)</h2>
